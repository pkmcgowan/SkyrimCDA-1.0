...
<link rel="stylesheet" type="text/css" href="../style/conjuration2style.css">
...
<div id="container">
	...
	<div id="content">
		<form id="main">
			...
			<div id="centerpane">
				<h3>Conjuration - Summon More(Add-on)</h3>
			...
			<div id="leftpane">
				...
				<div class="perk2">
					8: <span title="Level 1: can have two atronachs or raised undead at the same time					Level 2: can have four atronachs or raised undead at the same time					Level 3: can have six atronachs or raised undead at the same time					Level 4: can have eight atronachs or raised undead at the same time					Level 5: can have ten atronachs or raised undead at the same time">Summon More</span>...<br>
					<select id="perkNum7" tabindex="16" class="ctrlscheme" <?php $p=$_SESSION['perks']; if($p[7] == '-'){echo 'disabled';} ?> onchange="comboBoxEvent(7)">
						<option value="0" <?php $p=$_SESSION['perks']; if($p[7] == '0'){echo 'selected';} ?>>Not Selected</option>
						<option value="1" <?php $p=$_SESSION['perks']; if($p[7] == '1'){echo 'selected';} ?>>Summon More-Level 1</option>
						<option value="2" <?php $p=$_SESSION['perks']; if($p[7] == '2'){echo 'selected';} ?>>Summon More-Level 2</option>
						<option value="3" <?php $p=$_SESSION['perks']; if($p[7] == '3'){echo 'selected';} ?>>Summon More-Level 3</option>
						<option value="4" <?php $p=$_SESSION['perks']; if($p[7] == '4'){echo 'selected';} ?>>Summon More-Level 4</option>
						<option value="5" <?php $p=$_SESSION['perks']; if($p[7] == '5'){echo 'selected';} ?>>Summon More-Level 5</option>
					</select>
				</div>			
			</div>
			<div id="rightpane">
			...
			<input type="hidden" id="pagecode" value="M21">
		</form>
	</div>
	<div id="footer">
